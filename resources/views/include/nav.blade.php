    ...
    <div class="d-flex justify-content-center">
        ...
        <a href="/" class="d-flex align-items-center " style="padding-bottom: 10px">
            <div style="margin-top: 10px"><img width="250px"
                                               ...
                                               src="{{asset('storage/image/page_img/excel_logo.png')}}"></div>
        </a>


        <ul id="main-menu">

            <li class="li" style="margin-right: 15px"><a class="a" href="{{url('/engagement-ring')}}">ENGAGEMENT RING</a>
                    ...
                    <div class="dropdown-inner">
                        ...
                        <div class="dropdown-column">
                            ...
                            <div class="dropdown-case">
                                ...
                                <a href="{{url('/engagement-ring?category=free Form')}}">
                                    <div><span class="icon-Free-Form-01 jewelry-nav-icon"></span> Free Form</div>
                                </a>
                                <a href="{{url('/engagement-ring?category=pave')}}">
                                ...
                                <a href="{{url('/engagement-ring?brand=verragio')}}">
                                    <div>
                                        <img alt="Verragio Diamond Classic Engagement Gold Ring Wedding Band Jewellery Surrey Langley Vancouver Canada"
                                             src="{{asset('storage/image/logo/verragio.png')}}"></div>
                                </a>
                                <a href="{{url('/engagement-ring?brand=gabrielco')}}">
                                    <div>
                                        <img alt="Gabriel&Co Diamond Classic Engagement Ring Wedding Band Jewellery Surrey Langley Vancouver Canada"
                                             src="{{asset('storage/image/logo/gabriel.svg')}}"></div>
                                </a>
                                <a href="{{url('/engagement-ring?brand=valina')}}">
                                    <div>
                                        <img alt="Valina Diamond Classic Engagement Gold Ring Wedding Band Jewellery Surrey Langley Vancouver Canada"
                                             src="{{asset('storage/image/logo/valina.png')}}"></div>
                                </a>
                                <a href="{{url('/engagement-ring?brand=romance')}}">
                                    <div>
                                        <img alt="Romance Diamond Classic Engagement Gold Ring Wedding Band Jewellery Surrey Langley Vancouver Canada"
                                             src="{{asset('storage/image/logo/romance.png')}}"></div>
                                </a>
                                <a href="{{url('/engagement-ring?brand=simong')}}">
                                    <div>
                                        <img alt="Simon G. Diamond Classic Engagement Gold Ring Wedding Band Jewellery Surrey Langley Vancouver Canada"
                                             src="{{asset('storage/image/logo/simong.png')}}"></div>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <li class="li" ><a class="a" href="{{url('/wedding-band')}}">WEDDING BAND</a>
                <div class="dropdown-container">
                    <div class="dropdown-inner">
                        <div class="dropdown-column">
                            <h3>SHOP BY COLOR</h3>
                            <a href="{{url('/wedding-band?color=rose')}}">
                                <div><span class="icon-ring rose-gold"></span> Rose Gold</div>
                            </a>
                            <a href="{{url('/wedding-band?color=yellow')}}">
                                <diV><span class="icon-ring yellow-gold"></span> Yellow Gold</diV>
                            </a>
                            <a href="{{url('/wedding-band?color=white')}}">
                                <diV><span class="icon-ring white-gold"></span> White Gold</diV>
                            </a>
                            <a href="{{url('/wedding-band?color=platinum')}}">
                                <diV><span class="icon-ring platinum"></span> Platinum</diV>
                            </a>
                            <h3>DESIGNER BRANDS</h3>
                            <div class="dropdown-case">
                                ...
                                <a href="{{url('/wedding-band?brand=malo')}}">
                                    <div>
                                        <img alt="Malo Diamond Wedding Satin Gold Yellow White Rose Band Jewellery Surrey Langley Vancouver Canada"
                                             src="{{asset('storage/image/logo/malo.png')}}"></div>
                                </a>
                        ...
                        <div class="dropdown-column">
                            <h3>WOMEN STYLE</h3>
                            <div class="dropdown-case">
                                <a href="{{url('/wedding-band?category=curved')}}">
                ...
                <div class="dropdown-container">
                    <div class="dropdown-inner">
                        <div class="dropdown-column">
                            ...
                            <h3>JEWELRY</h3>
                            <div class="dropdown-case">
                                <a href="{{url('/fine-jewellery?page=1&category=rings&gem=diamond')}}">
                                    <div><span class="icon-Diamond-Ring-01 jewelry-nav-icon"></span> Diamond Rings</div>
                                </a>
                                <a href="{{url('fine-jewellery?page=1&category=necklaces&gem=diamond')}}">
                                    <div><span class="icon-Choker-01 jewelry-nav-icon"></span> Diamond Necklaces</div>
                                </a>
                                <a href="{{url('fine-jewellery?page=1&category=bracelets&gem=diamond')}}">
                                    <div><span class="icon-Tennis-Bracelet-01 jewelry-nav-icon"></span> Diamond Bracelet
                                    </div>
                                </a>
                                <a href="{{url('fine-jewellery?page=1&category=earrings&gem=diamond')}}">
                                    <div><span class="icon-Drops-01 jewelry-nav-icon"></span> Diamond Earrings</div>
                                </a>
                                <a href="{{url('fine-jewellery?page=1&category=earrings&style=Stud&gem=diamond')}}">
                ...
                <div class="dropdown-container">
                    <div class="dropdown-inner">
                        <div class="dropdown-column">
                            ...
                            <div class="dropdown-case">
                                <a href="{{url('/education-diamond-carat')}}">
                                    <div>Diamond Carat</div>
                                </a>
                                <a href="{{url('/education-diamond-clarity')}}">
                                    <div>Diamond Clarity</div>
                                </a>
                                <a href="{{url('/education-diamond-color')}}">
                                    <div>Diamond Color</div>
                                </a>
                                <a href="{{url('/education-diamond-cut')}}">
                                    <div>Diamond Cut</div>
                                </a>
                                <a href="{{url('/education-diamond-shape')}}">
                        ...
                        <div class="dropdown-column">
                            ...
                            <div class="dropdown-case">
                                <a href="{{url('/education-eng-style')}}">
                                    <div>Style</div>
                                </a>
                                <a href="{{url('/education-eng-setting')}}">
                                    <div>Setting</div>
                                </a>
                            </div>
                        </div>
                        <div class="dropdown-column">
                            ...
                            <div class="dropdown-case">
                                <a href="{{url('/education-weddingband-style')}}">
                                    <div>Style</div>
                                </a>
                                <a href="{{url('/education-weddingband-metal')}}">
      ...
      <div class="right-bar" style="margin: auto;display: inline-block">
          ...
          <a href="{{url('/contact')}}" style="margin-right: 5px"><span class="icon-phone"></span></a>


                          @guest
                                <a class="login-nav" href="{{ route('login') }}" style="margin-right: 5px"><span class="icon-user"></span><span class="top-text">{{ __('LOGIN') }}</span></a>
                          @else
                              <a class="login-nav" href="{{url('/home')}}" style="margin-right: 5px"><span class="icon-user"></span><span class="top-text">PROFILE</span></a>
                              <a class="login-nav" href="{{ route('logout') }}" style="margin-right: 5px"
