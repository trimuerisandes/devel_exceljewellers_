...
@section('page-title')
Natural Mined {{ $gem->shape }} Diamond gemstone Jewelry Canada
@endsection

@section('page-description')
Shop Natural Mined {{ $gem->shape }} Cut Style Diamond gemstone Stones. Earth created made gemstone Engagement Rings Canada Surrey Vancouver Langley
@endsection
...
@section('main')
    ...
    <div id="item-container">
        ...
        <div class="item-image">
            @if(strpos($gem->video_link,'.mp4') == true)
        ...
        <div class="selection-container">
            <div class="gemstone-name">{{$gem->carat}} CT {{$gem->clarity}} {{$gem->color}} Color {{$gem->shape}} Natural Mined Diamond</div>
            ...
            <div class="social-media">
                <ul>
                    ...
                    <div class="social-media-ctn">
                        ...
                        href="https://twitter.com/intent/tweet?text={{$gem->carat.' CT '.$gem->clarity.' '.$gem->color.' Color '.$gem->shape.' Mined Diamond💎%20%7C%20'.url()->current()}}"
                        data-size="large"></a>
                        </div>
    ...
    <div class="details-container">
        ...
        <div class="details-inner three-inner">
            <div class="details-case">
                <div class="sub-title"><b>STONE DESCRIPTION</b></div>
                <hr>
                {{$gem->carat}} CT {{$gem->clarity}} {{$gem->color}} color {{$gem->shape}} Natural Mined Diamond.
            </div>
            <div class="details-case">
            ...
            <div class="details-case">
                ...
                <hr>
                <div><b>Certificate Number:</b> <span class="item_certificate">{{ $gem->certificate }}</span></div>
                <div><b>Certificate Report:</b> <a href="{{$gem->report}}" target="_blank">Click To View Report</a></div>
                <div>@if(strpos($gem->report,'gia.edu')) <img class="gia-cert" src="{{ url('storage/image/page_img/gia.png') }}">@endif</div>
            </div>
        ...
        <div class="main-carousel" data-flickity='{ "cellAlign": "left", "contain": true }'>
         @foreach($similar as $similar)
          <div class="carousel-cell">
            <a href="{{url('/diamonds/'.$similar->id)}}">
...
<script type="text/javascript" src="{{ URL::asset('js/p_diamond.js?'.time().'') }}"></script>
