...
<form action="/newexcel/jewellery-post1" method="POST" enctype="multipart/form-data" >
	@csrf
	...
	<div class="group">
		...
		<input type="" name="style" placeholder="Item Style">

		<input type="" name="main_stone" placeholder="Main Stone">

		<input type="" name="other_stone" placeholder="Other Stone">
	...
	<div>
		...
		<div class="individual">
			...
			<input type="" name="stone_color[]" placeholder="Stone Color">

			<input type="" name="stone_clarity[]" placeholder="Stone Clarity">
