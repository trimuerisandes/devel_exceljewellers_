				...
				<div class="filter-dropdown">
					...
					<a param-name="gem" param-value="diamond">
						...
						<div class="filter-case-inner stone-case">
							<img src="<?php echo e(asset('storage/image/gemstone/diamond.png')); ?>">
					...
					<a param-name="gem" param-value="garnet">
						...
						<div class="filter-case-inner stone-case">
							<img src="<?php echo e(asset('storage/image/gemstone/garnet.png')); ?>">
					...
					<a param-name="gem" param-value="pearl">
						...
						<div class="filter-case-inner stone-case">
							<img src="<?php echo e(asset('storage/image/gemstone/pearl.png')); ?>">
					...
					<a param-name="gem" param-value="sapphire">
						...
						<div class="filter-case-inner stone-case">
							<img src="<?php echo e(asset('storage/image/gemstone/sapphire.png')); ?>">
					...
					<a param-name="gem" param-value="emerald">
						...
						<div class="filter-case-inner stone-case">
							<img src="<?php echo e(asset('storage/image/gemstone/emerald.png')); ?>">
					...
					<a param-name="gem" param-value="ruby">
						...
						<div class="filter-case-inner stone-case">
							<img src="<?php echo e(asset('storage/image/gemstone/ruby.png')); ?>">
					...
					<a param-name="gem" param-value="amethyst">
						...
						<div class="filter-case-inner stone-case">
							<img src="<?php echo e(asset('storage/image/gemstone/amethyst.png')); ?>">
					...
					<a param-name="gem" param-value="aquamarine">
						...
						<div class="filter-case-inner stone-case">
							<img src="<?php echo e(asset('storage/image/gemstone/aquamarine.png')); ?>">
					...
					<a param-name="gem" param-value="citrine">
						...
						<div class="filter-case-inner stone-case">
							<img src="<?php echo e(asset('storage/image/gemstone/citrine.png')); ?>">
					...
					<a param-name="gem" param-value="peridot">
						...
						<div class="filter-case-inner stone-case">
							<img src="<?php echo e(asset('storage/image/gemstone/peridot.png')); ?>">
...
<?php /**PATH /Users/trimuerisandes/PhpstormProjects/devel_exceljewellers/resources/views/include/fj-filter.blade.php ENDPATH**/ ?>