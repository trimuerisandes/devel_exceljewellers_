        ...
        <div class="cyo-bar-step step step-item " data-view-link="/engagement-ring-settings/">
            <div class="node">
                <div class="node-skin" style="border-left: 1px solid #e5e5e5;">
                    ...
                    <div class="cont">
                        <?php if(session('create_ring.engagement-ring')): ?>

                            $<?php echo e(number_format(\App\Helper\AppHelper::conversion(session('create_ring.engagement-ring')['currency'],session('create_ring.engagement-ring')['price'],session('currency')),2)); ?>

                            <a href="<?php echo e(url('/engagement-ring/'.session('create_ring.engagement-ring')['id'].'')); ?>">
                        ...
                        <?php else: ?>
                        <a class="uncomplete-eng" href="<?php echo e(url('/engagement-ring')); ?>">Select Setting</a> <?php endif; ?>
                    </div>
                    <div class="pho">
                        <?php if(session('create_ring.engagement-ring')): ?>
                                <img class="stage-img" src="<?php echo e(session('create_ring.engagement-ring')['img']); ?>">
                        <?php endif; ?>
                    </div>
        ...
        <div class="cyo-bar-step step step-item " data-view-link="/design-your-own-engagement-ring/">
            <div class="node">
                <div class="node-skin node-skin-diamond">
                    ...
                    <div class="cont">
                        <?php if(session('create_ring.stone')): ?>

                        <span class="dia_retail">$<?php echo e(number_format(\App\Helper\AppHelper::conversion(session('create_ring.stone')['currency'],session('create_ring.stone')['retail'],session('currency')),2)); ?></span>
                        <a href="<?php echo e(url('/diamonds#/'.session('create_ring.stone')['stone_id'].'')); ?>">
                            <a href="<?php echo e(session('create_ring.stone')['url']); ?>">
                                <div class="view-btn">View</div>
                            </a>
                        </a>
                        ...
                        <?php else: ?>
                        <a class="uncomplete-dia select-stones" href="<?php echo e(url('/diamonds')); ?>">Select Stone</a> <?php endif; ?>

                    </div>
                    <div class="pho">
                        <?php if(session('create_ring.stone')): ?>
                        <img class="stage-img" id="<?php echo e(session('create_ring.stone')['stone_id']); ?>" src="<?php echo e(asset('storage/image/moissanite/gem-shape/'.session('create_ring.stone')['shape'].'.jpg')); ?>">
                        <?php endif; ?>
                    </div>
        ...
        <div class="cyo-bar-step step step-item active-step" data-view-link="/design-your-own-engagement-ring/">
            <div class="node">
                <div class="node-skin" style="border-left: 16px solid transparent;">
                    <?php if(session('create_ring.stone') && session('create_ring.engagement-ring')): ?>
                    ...
                    <div class="cont">
                        <?php if(session('create_ring.stone') && session('create_ring.engagement-ring')): ?>
                        <div>
                            <a class="complete-ring" href="<?php echo e(url('/complete-ring')); ?>">
                                <span class="complete-ring-icon icon-diamond-ring"></span><div class="stage-text view-ring">View Ring</div>
                            </a>
                        </div>
                        <?php elseif(session('create_ring.engagement-ring')): ?>
                        <a href="<?php echo e(url('/diamonds')); ?>"><div class="stage-text">Complete Ring</div></a>
                        <?php elseif(session('create_ring.stone')): ?>
                        <a href="<?php echo e(url('/engagement-ring')); ?>"><div class="stage-text">Complete Ring</div></a>
                        <?php else: ?>
...
<?php /**PATH /Users/trimuerisandes/PhpstormProjects/devel_exceljewellers/resources/views/include/stage.blade.php ENDPATH**/ ?>