			...
			<div class="filter-dropdown brand-dropdown">
				...
				<a href="<?php echo e(url('/wedding-band?brand=malo')); ?>">
					<div class="filter-case-inner brand-case" id="maloo">
						<img src="<?php echo e(asset('storage/image/logo/malo.png')); ?>">
					</div>
				</a>
		...
		<div class="filter-dropdown-outer">
			<div class="filter-dropdown">
				...
				<a param-name="metal{}color" param-value="10k{}rose">
					...
					<div class="filter-case-inner metal-case">
						<span class="icon-ring rose-gold"></span> <div><span class="metal-carat">10K</span> <span class="metal-color">Rose</span></div>
					</div>
				...
				<a param-name="metal{}color" param-value="18k{}rose">
					...
					<div class="filter-case-inner metal-case">
						<span class="icon-ring rose-gold"></span> <div><span class="metal-carat">18K</span> <span class="metal-color">Rose</span></div>
					</div>
			...
			<div class="filter-dropdown">
				<a param-name="category" param-value="curved">
					<div class="filter-case-inner style-case">
						<span class="icon-Curved-01 dd-ring-icon"></span><div class="style-text">curved</div>
					</div>
				</a>
				<a param-name="category" param-value="anniversary">
					<div class="filter-case-inner style-case">
						<span class="icon-Anniversary-01 dd-ring-icon"></span><div class="style-text">Anniversary</div>
					</div>
				</a>
				<a param-name="category" param-value="jacket">
					<div class="filter-case-inner style-case">
						<span class="icon-Jacket-01 dd-ring-icon"></span><div class="style-text">Jacket</div>
					</div>
				</a>
				<a param-name="category" param-value="eternity">
					<div class="filter-case-inner style-case">
						<span class="icon-Eternity-01 dd-ring-icon"></span><div class="style-text">Eternity</div>
					</div>
				</a>
				<a param-name="category" param-value="stackable">
					<div class="filter-case-inner style-case">
						<span class="icon-Stackable-01 dd-ring-icon"></span><div class="style-text">Stackable</div>
					</div>
				</a>
				<a param-name="category" param-value="men classic">
					<div class="filter-case-inner style-case">
						<span class="icon-Classic-01 dd-ring-icon"></span><div class="style-text">Men Classic</div>
					</div>
				</a>
				<a param-name="category" param-value="alternative">
					<div class="filter-case-inner style-case">
						<span class="icon-Alternative-01 dd-ring-icon"></span><div class="style-text">Men Alternative</div>
					</div>
				</a>
				<a param-name="category" param-value="lux">
					<div class="filter-case-inner style-case">
						<span class="icon-Lux-01 dd-ring-icon"></span><div class="style-text">Men Lux</div>
					</div>
				</a>
				<a param-name="category" param-value="men diamond">
					<div class="filter-case-inner style-case">
						<span class="icon-Diamond-01 dd-ring-icon"></span><div class="style-text">Men Diamond</div>
					</div>
				</a>
			</div>	
		</div>
...
<?php /**PATH /Users/trimuerisandes/PhpstormProjects/devel_exceljewellers/resources/views/include/wed-filter.blade.php ENDPATH**/ ?>